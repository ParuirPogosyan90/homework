...
public class AuthorBookTest {
    ...
    private static final String ADD_AUTHOR = "1";//ДОБАВИТЬ_АВТОРА
    private static final String ADD_BOOK = "2";//ДОБАВИТЬ_книгу
    private static final String SEARCH_AUTHORS = "3";//ПОИСК_АВТОРОВ
    private static final String SEARCH_AUTHORS_BY_AGE = "4";//ПОИСК_АВТОР ВОЗВРОСТ
    private static final String SEARCH_BOOKS_BY_TITLE = "5";//ПОИСК_ԳՐՔԻ ՎԵՐՆԱԳԻՐԸ
    private static final String PRINT_AUTHORS = "6";//ՏՊԵԼ ՀԵՂԻՆԱԿԻՆ
    private static final String PRINT_BOOKS = "7";//ՏՊԵԼ ԳԻՐՔԸ
    private static final String SEARCH_BOOKS_BY_AUTHOR = "8";//ԳՏՆԵԼ ԳՐՔԻ ՀԵՂԻՆԱԿԻՆ
    private static final String COUNT_BOOKS_BY_AUTHOR = "9";//ՀԱՇՎԵԼ ԳՐՔԻ ՀԵՂԻՆԱԿԻՆ
    private static final String CHANGE_AUTHOR = "10";//ՓՈԽԵԼ ՀԵՂԻՆԱԿԻՆ
    private static final String CHANGE_BOOK_AUTHOR = "11";//ՓՈԽԵԼ ԳՐՔԻ ՀԵՂԻՆԱԿԻՆ
    private static final String DELETE_AUTHOR = "12";//ՋՆՋԵԼ ՀԵՂԻՆԱԿԻՆ
    private static final String DELETE_BOOK = "13";//ՋՆՋԵԼ ԳԻՐՔԸ
    private static final String DELETE_BOOK_BY_AUTHOR = "14";//ՋՆՋԵԼ ԳՐՔԻ ՀԵՂԻՆԱԿԻՆ
    ...
    public static void main(String[] args) {
        ...
        authorStorage.add(new Author("Paruir", "Pogosyan", 31, "paruir.pogosyan90@mail.com", "male"));
        authorStorage.add(new Author("Artyom", "Xachatryan", 16, "artyon@mail.com", "male"));
        authorStorage.add(new Author("Vaghan", "Xachatryan", 21, "vaghan@mail.com", "male"));
